    ...
    <div className="space-y-4">
      ...
      >
        <div className="space-y-2 text-sm">
          ...
          <p className="text-muted-foreground">
            Connected for Constant Contact integrations only. Klaviyo sends welcome, abandoned
            checkout, the post-purchase note, replenish, and win-back. Stripe sends the payment
            receipt. Resend sends the order, quote, support, and back-in-stock mail.
          </p>
